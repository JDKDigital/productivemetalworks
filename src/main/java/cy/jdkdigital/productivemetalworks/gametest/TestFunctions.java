 ...
 *
 * <p>Called from the {@link ProductiveMetalworks} mod constructor. After {@link #init()} returns,
...
public final class TestFunctions
{
    ...
    public static ResourceKey<Consumer<GameTestHelper>> key(String name) {
        return ResourceKey.create(Registries.TEST_FUNCTION, Identifier.fromNamespaceAndPath(ProductiveMetalworks.MODID, name));
    }
     ...
     * (i.e. after {@code MetalworksGameTests} class init).
     */
