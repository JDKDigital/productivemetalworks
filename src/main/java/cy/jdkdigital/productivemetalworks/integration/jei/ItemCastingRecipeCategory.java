...
public class ItemCastingRecipeCategory extends AbstractRecipeCategory<RecipeHolder<ItemCastingRecipe>>
{
    ...
    public ItemCastingRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.background = guiHelper.drawableBuilder(Identifier.fromNamespaceAndPath(ProductiveMetalworks.MODID, "textures/gui/jei/item_casting.png"), 0, 0, 165, 68).setTextureSize(165, 68).build();
    }

    @Override
    public void draw(RecipeHolder<ItemCastingRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
